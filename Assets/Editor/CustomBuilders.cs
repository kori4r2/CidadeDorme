...
namespace CidadeDorme.Editor {
    public static class CustomBuilders {
        public static void BuildWebGL() {
            string[] arguments = Environment.GetCommandLineArgs();
            int index = Array.IndexOf(arguments, "CidadeDorme.Editor.CustomBuilders.BuildWebGL");
        ...
        public static void BuildAndroid() {
            string[] arguments = Environment.GetCommandLineArgs();
            int index = Array.IndexOf(arguments, "CidadeDorme.Editor.CustomBuilders.BuildAndroid");
            if (index < 0 || index >= arguments.Length - 1) {
